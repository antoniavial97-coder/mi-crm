    ...
    setTasks(prev=>prev.map(t=>{
      ...
      if(nowDone&&t.clientId){
        ...
        if(client){
          ...
          // Usar nombre empresa como clave estable
          const key=client.companyName.toLowerCase();
          const newRecent={...recentContacts,[key]:hoy};
          // No podemos setRecentContacts acá directamente, usamos onMarkContact
          onMarkContact(t.clientId);
        }
      }
